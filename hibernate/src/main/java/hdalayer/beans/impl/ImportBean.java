...
//    }
    ...
    private Boolean checkDoubleCountry(String countryName) throws SQLException{
        return new CountryDaoImpl().getCountry(countryName) == null;
    }

    @Override
    public ArrayList<ResultSet> loadCountry(String direct) throws IOException, JDOMException, SAXException, SQLException {
        return null;
    }

    @Override
    public ArrayList<ResultSet> loadHoliday(String direct) throws IOException, JDOMException, SAXException, SQLException {
        return null;
    }
